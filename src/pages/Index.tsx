...
const Index = () => {
  ...
  const isInputValid = inputType === "image" ? !!imageFile : mermaidText.trim().length > 0;
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const analysisResult = await analyzeArchitecture({
        inputType,
        mermaidText: inputType === "mermaid" ? mermaidText : undefined,
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        {/* Analyzer Section */}
        <section ref={analyzerRef} id="analyzer" className="border-b border-border/50 py-16">
