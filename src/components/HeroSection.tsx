...
export function HeroSection({ onAnalyzeClick }: HeroSectionProps) {
  const steps = [
    { icon: Upload, title: "Upload", description: "Add your architecture diagram or Mermaid code" },
    { icon: Cpu, title: "Extract", description: "AI identifies components and data flows" },
    { icon: ShieldCheck, title: "STRIDE + Mitigations", description: "Get comprehensive threat analysis" },
  ];
      ...
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
            Generate{" "}
            <span className="gradient-text">STRIDE threat models</span>
            {" "}from architecture diagrams
          </h1>
          
          <p className="mb-10 text-lg text-muted-foreground sm:text-xl">
            Upload your system architecture and get comprehensive threat analysis with actionable mitigations in seconds.
          </p>
          
          <Button size="lg" onClick={onAnalyzeClick} className="group gap-2 text-base">
            Analyze Diagram
