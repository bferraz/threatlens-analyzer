...
const trustZoneColors: Record<string, string> = {
  external: "bg-orange-500/10 text-orange-600 dark:text-orange-400 border-orange-500/20",
  dmz: "bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 border-yellow-500/20",
  internal: "bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/20",
};
          ...
          {components.map((component) => {
            ...
            return (
              ...
              >
                ...
                <Badge
                  variant="outline"
                  className={`shrink-0 text-xs capitalize ${trustZoneColors[component.trust_zone]}`}
                >
